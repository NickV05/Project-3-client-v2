...
function Navbar() {
  ...
  <div class="flex w-full flex-wrap items-center justify-between px-3">
    <div>
    <Link to="/" class="mx-2 my-1 flex items-center text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 lg:mb-0 lg:mt-0">
        <img
          class ="h-10"
      ...
      <div class="flex items-center">
       ...
       {getToken() && (
        ...
        <span className = "flex mr-7">
          <img src="/public/cart.png" className="w-8 h-8 mr-3"/> {number !== 0 && <p className="text-base mt-1 font-bold">{number}</p>}
        </span>
        </Link>
