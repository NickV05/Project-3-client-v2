...
<div
  id="defaultModal"
  tabIndex="-1"
  className="flex md:fixed md:mt-9 top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 md:h-modal md:h-full"
>
  <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
    <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
      ...
      <form onSubmit={handleFormSubmit}>
        <div className="grid md:gap-4 mb-4 sm:grid-cols-2">
          <div>
        ...
        <button
          ...
          type="submit"
          className="text-white bg-blue-500 inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 
