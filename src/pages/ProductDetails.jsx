    ...
    const handleTextChange = (e) => {
      ...
      return (
        ...
        <div className="flex flex-col justify-between h-full w-full md:w-1/2 max-w-xs mx-auto space-y-4 min-h-128">
          <Link to="/">
            <button className=" text-white border border-palette-primary text-palette-primary text-lg 
          ...
          <div className="font-primary">
            ...
            <div className="text-xl text-palette-primary font-medium py-4 px-1">
              <p className="text-2xl">{details.cost} $</p>
            </div>
          ...
          <div className="w-full">
                  ...
                  <div>
                    {isOwner() && (
                      <Link to={`/product/edit/${productId}`}>
                        <button className=" text-white border border-palette-primary text-palette-primary text-lg 
            font-primary font-semibold pt-2 pb-1 leading-relaxed flex justify-center items-center focus:ring-1 focus:ring-palette-light 
            focus:outline-none w-full hover:bg-palette-lighter rounded-sm">Edit Product info</button>
                      </Link>
                    )}
                  </div>
                )}
           ...
           {isNotOwner() &&<button
              ...
              <>
                {!isEditing && (
                  <div>
                    ...
                    <button onClick={editProduct} className=" text-white border border-palette-primary text-palette-primary text-lg 
            font-primary font-semibold pt-2 pb-1 leading-relaxed flex justify-center items-center focus:ring-1 focus:ring-palette-light 
            focus:outline-none w-full hover:bg-palette-lighter rounded-sm">Write a customer review</button>
                  </div>
                )}
            ...
            font-primary font-semibold pt-2 pb-1 leading-relaxed flex justify-center items-center focus:ring-1 focus:ring-palette-light 
            focus:outline-none w-full hover:bg-palette-lighter rounded-sm">Post Review</button>
                  </form>
                )}
              </>
            )}
